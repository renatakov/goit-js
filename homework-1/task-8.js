...
// __MCE_ITEM____MCE_ITEM__·       При загрузке страницы пользователю предлагается в prompt ввести число. Ввод добавляется к значению переменной total.

// __MCE_ITEM____MCE_ITEM__·       Операция ввода числа продолжается до тех пор, пока пользователь не нажмет кнопку Cancel в prompt.

// __MCE_ITEM____MCE_ITEM__·       После того как пользователь прекратил ввод нажав кнопку Cancel, показать alert со строкой 'Общая сумма чисел равна [сумма]'.
...
// do {
//     input = Number(prompt("введите следующее число"));
//     total += input;
//     console.log(total);
// } while (input) 
